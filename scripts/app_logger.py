...
class App_Logger:
    ...
    def get_file_handler(self) -> logging.FileHandler :
        ...
        Path("C:\Data Science\project-6-Pharmaceutical\Rossmann-Sales\logs").mkdir(parents=True, exist_ok=True)
        file_handler = TimedRotatingFileHandler(f"C:\Data Science\project-6-Pharmaceutical\Rossmann-Sales\logs/app.log", when='d')
